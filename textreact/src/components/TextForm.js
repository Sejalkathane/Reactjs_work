...
const copy=()=>{
  ...
  return (
    ...
    <div className="container" style={{color:props.mode==='dark'?'white':'black'}}>
      ...
      <button type="button"  onClick={Slice}  className="btn btn-outline-info p-3 m-3 ">Slice1</button>
      <button type="button"  onClick={copy}  className="btn p-3 m-3 btn1">Copy</button>
